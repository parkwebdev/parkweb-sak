...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      fontSize: {
        '3xs': ['0.5rem', { lineHeight: '0.75rem' }],      // 8px - micro avatars
      ...
      fontFamily: {
        sans: ['Helvetica Neue', 'Helvetica', 'Arial', 'ui-sans-serif', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Noto Sans', 'sans-serif'],
