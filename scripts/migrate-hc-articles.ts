/**
 * Help Center Article Migration Script
 * 
 * This script contains all 32 Help Center articles converted from TSX 
 * React components to data-* HTML format for database storage.
 * 
 * Migration is done via SQL UPDATE statements or admin UI.
 * 
 * Conversion Rules Applied:
 * - <HCCallout variant="X" title="Y">content</HCCallout> 
 *   → <div data-callout data-callout-type="X"><strong>Y</strong> content</div>
 * 
 * - <HCFeatureGrid columns={N}>...</HCFeatureGrid>
 *   → <div data-feature-grid data-columns="N">...</div>
 * 
 * - <HCFeatureCard title="T" description="D" icon={<IconName />} />
 *   → <div data-feature-card data-feature-icon="IconName" data-feature-title="T" data-feature-description="D"></div>
 * 
 * - <HCArticleLink categoryId="C" articleSlug="S">text</HCArticleLink>
 *   → <a data-article-link data-category-id="C" data-article-slug="S" href="/help-center?category=C&article=S">text</a>
 * 
 * - <HCRelatedArticles articles={[...]} />
 *   → <div data-related-articles data-articles='[...]'></div>
 * 
 * - <HCStepByStep steps={[...]}>
 *   → <div data-stepbystep>...</div>
 * 
...
// ============================================================================
// ALL MIGRATED ARTICLE CONTENT (32 ARTICLES)
// ============================================================================

export const MIGRATED_ARTICLES: ArticleMapping[] = [
  // ============================================================================
  ...
  // ============================================================================
  {
    ...
    htmlContent: `<p>Welcome to <strong>Pilot</strong> – your AI-powered customer engagement platform. Pilot helps you automate conversations, capture leads, and provide exceptional support to your website visitors 24/7.</p>
...
<div data-related-articles data-articles='[{"categoryId":"getting-started","articleSlug":"quick-start","title":"Quick Start Guide"},{"categoryId":"ari","articleSlug":"overview","title":"Understanding Ari"},{"categoryId":"getting-started","articleSlug":"navigation","title":"Navigating the App"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>This guide will walk you through setting up Pilot and getting your AI agent live on your website in just a few minutes.</p>
...
<div data-related-articles data-articles='[{"categoryId":"getting-started","articleSlug":"welcome","title":"Welcome to Pilot"},{"categoryId":"ari","articleSlug":"knowledge-sources","title":"Knowledge Sources"},{"categoryId":"ari","articleSlug":"installation","title":"Installing the Widget"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Pilot is designed to be intuitive and easy to navigate. This guide will help you find your way around the platform quickly.</p>
...
<div data-related-articles data-articles='[{"categoryId":"getting-started","articleSlug":"welcome","title":"Welcome to Pilot"},{"categoryId":"getting-started","articleSlug":"quick-start","title":"Quick Start Guide"},{"categoryId":"getting-started","articleSlug":"dashboard","title":"Dashboard Overview"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>The Dashboard is your command center after completing initial setup. It provides a quick overview of your Ari deployment status and key actions.</p>
...
<div data-related-articles data-articles='[{"categoryId":"analytics","articleSlug":"overview","title":"Analytics Overview"},{"categoryId":"inbox","articleSlug":"overview","title":"Inbox Overview"}]'></div>`,
  ...
  // ============================================================================
  {
    ...
    htmlContent: `<p><strong>Ari</strong> is your AI-powered assistant that engages with website visitors 24/7. Built on advanced language models, Ari can understand context, provide helpful responses, and take actions on behalf of your business.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"knowledge-sources","title":"Adding Knowledge Sources"},{"categoryId":"ari","articleSlug":"installation","title":"Installing the Widget"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>The System Prompt is the foundation of Ari's personality and behavior. It's a set of instructions that guides how Ari responds to visitors, handles conversations, and represents your brand.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"knowledge-sources","title":"Knowledge Sources"},{"categoryId":"ari","articleSlug":"appearance","title":"Customizing Appearance"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Make the chat widget feel like a natural part of your website by customizing its appearance to match your brand.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"welcome-messages","title":"Welcome & Messages"},{"categoryId":"ari","articleSlug":"installation","title":"Installing the Widget"},{"categoryId":"ari","articleSlug":"knowledge-sources","title":"Knowledge Sources"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>First impressions matter. Configure Ari's welcome message and widget content to greet visitors and guide them through your chat experience.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"appearance","title":"Customizing Appearance"},{"categoryId":"ari","articleSlug":"lead-capture","title":"Lead Capture"},{"categoryId":"ari","articleSlug":"help-articles","title":"Help Articles"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Ari can capture visitor information before starting a conversation. Configure a contact form to collect leads and qualify visitors automatically.</p>
...
<div data-related-articles data-articles='[{"categoryId":"leads","articleSlug":"overview","title":"Lead Management"},{"categoryId":"ari","articleSlug":"welcome-messages","title":"Welcome & Messages"},{"categoryId":"settings","articleSlug":"notifications","title":"Notification Preferences"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Knowledge sources are how Ari learns about your business. The more relevant information you provide, the better Ari can assist your visitors.</p>

<h2 id="accessing-knowledge">Accessing Knowledge Sources</h2>
<p>To manage your knowledge sources:</p>
<ol>
...
<p>Point Ari to your website pages and it will automatically extract and index the content. Great for:</p>
<ul>
...
<p>Upload PDFs, Word documents, or other files. Ideal for:</p>
<ul>
...
<p>Directly enter information that might not exist elsewhere:</p>
<ul>
...
<div data-callout data-callout-type="tip"><strong>Pro Tip</strong> Add your most frequently asked questions first – these will have the biggest immediate impact on customer satisfaction.</div>

<h2 id="managing-sources">Managing Sources</h2>
<p>From the Knowledge section, you can:</p>
<ul>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"overview","title":"Understanding Ari"},{"categoryId":"ari","articleSlug":"system-prompt","title":"Writing a System Prompt"},{"categoryId":"getting-started","articleSlug":"quick-start","title":"Quick Start Guide"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>If your business has multiple locations, configure each one so Ari can provide location-specific information, availability, and directions.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"integrations","title":"Integrations"},{"categoryId":"planner","articleSlug":"overview","title":"Using the Planner"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Help Articles are a self-service knowledge base that appears in the chat widget. Visitors can browse articles to find answers without needing to chat with Ari.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"knowledge-sources","title":"Knowledge Sources"},{"categoryId":"ari","articleSlug":"announcements","title":"Announcements"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Announcements are eye-catching banners that appear at the top of the chat widget. Use them to highlight promotions, events, or important updates.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"appearance","title":"Customizing Appearance"},{"categoryId":"ari","articleSlug":"welcome-messages","title":"Welcome & Messages"},{"categoryId":"ari","articleSlug":"news","title":"News"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>The News feature lets you share updates, blog posts, and stories directly in the chat widget.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"announcements","title":"Announcements"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Custom Tools extend Ari's capabilities by connecting to external services and APIs.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"webhooks","title":"Webhooks"},{"categoryId":"ari","articleSlug":"api-access","title":"API Access"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Webhooks allow Pilot to notify your external systems when events happen.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"custom-tools","title":"Custom Tools"},{"categoryId":"ari","articleSlug":"integrations","title":"Integrations"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Connect Pilot to your existing tools and services.</p>
...
<div data-related-articles data-articles='[{"categoryId":"planner","articleSlug":"overview","title":"Using the Planner"},{"categoryId":"ari","articleSlug":"webhooks","title":"Webhooks"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>The Pilot API allows developers to interact with Ari programmatically.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"webhooks","title":"Webhooks"},{"categoryId":"ari","articleSlug":"custom-tools","title":"Custom Tools"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Once you've configured Ari, it's time to install the widget on your website.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"appearance","title":"Customizing Appearance"},{"categoryId":"ari","articleSlug":"knowledge-sources","title":"Adding Knowledge Sources"}]'></div>`,
  ...
  // ============================================================================
  {
    ...
    htmlContent: `<p>The Inbox is where you manage all conversations between Ari and your visitors.</p>
...
<div data-related-articles data-articles='[{"categoryId":"inbox","articleSlug":"takeover","title":"Human Takeover"},{"categoryId":"leads","articleSlug":"overview","title":"Lead Management"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>The takeover feature lets you seamlessly step in and take control of a conversation.</p>
...
<div data-related-articles data-articles='[{"categoryId":"inbox","articleSlug":"overview","title":"Managing Conversations"},{"categoryId":"settings","articleSlug":"notifications","title":"Notification Preferences"}]'></div>`,
  ...
  // ============================================================================
  {
    ...
    htmlContent: `<p>The Leads section helps you manage and track potential customers.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"lead-capture","title":"Lead Capture Settings"},{"categoryId":"inbox","articleSlug":"overview","title":"Managing Conversations"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Lead stages help you organize and track leads through your sales process.</p>
...
<div data-related-articles data-articles='[{"categoryId":"leads","articleSlug":"overview","title":"Lead Management"}]'></div>`,
  ...
  // ============================================================================
  {
    ...
    htmlContent: `<p>The Planner helps you manage appointments, showings, and events.</p>
...
<div data-related-articles data-articles='[{"categoryId":"ari","articleSlug":"custom-tools","title":"Custom Tools"},{"categoryId":"leads","articleSlug":"overview","title":"Lead Management"}]'></div>`,
  ...
  // ============================================================================
  {
    ...
    htmlContent: `<p>The Analytics section gives you insights into how Ari is performing.</p>
...
<div data-related-articles data-articles='[{"categoryId":"analytics","articleSlug":"report-builder","title":"Report Builder"},{"categoryId":"inbox","articleSlug":"overview","title":"Managing Conversations"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>The Report Builder helps you create comprehensive reports to share with your team.</p>
...
<div data-related-articles data-articles='[{"categoryId":"analytics","articleSlug":"overview","title":"Analytics Overview"}]'></div>`,
  ...
  // ============================================================================
  {
    ...
    htmlContent: `<p>General settings control your organization's basic information.</p>
...
<div data-related-articles data-articles='[{"categoryId":"settings","articleSlug":"profile","title":"Profile Settings"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Your profile contains your personal information and preferences.</p>
...
<div data-related-articles data-articles='[{"categoryId":"settings","articleSlug":"general","title":"General Settings"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Invite team members to collaborate on Pilot.</p>
...
<div data-related-articles data-articles='[{"categoryId":"settings","articleSlug":"general","title":"General Settings"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Manage your Pilot subscription, update payment methods, and view invoices.</p>
...
<div data-related-articles data-articles='[{"categoryId":"settings","articleSlug":"usage","title":"Usage"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>The Usage page shows how your team is using Pilot.</p>
...
<div data-related-articles data-articles='[{"categoryId":"settings","articleSlug":"billing","title":"Billing & Subscription"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Control how and when Pilot notifies you about important events.</p>
...
<div data-related-articles data-articles='[{"categoryId":"settings","articleSlug":"team","title":"Managing Your Team"}]'></div>`,
  },
  {
    ...
    htmlContent: `<p>Sessions show you where your account is currently logged in.</p>
...
/**
 * Generate SQL UPDATE statements for migrating articles
 */
export function generateMigrationSQL(articles: ArticleMapping[]): string {
  return articles.map(article => {
    const escapedContent = article.htmlContent.replace(/'/g, "''");
    const escapedDesc = (article.description || '').replace(/'/g, "''");
    return `UPDATE platform_hc_articles 
...
// Export for use in edge functions or scripts
export default MIGRATED_ARTICLES;
