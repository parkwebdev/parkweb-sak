...
export const PaneContextMenu = memo(function PaneContextMenu({
  ...
  return (
    <>
      ...
      <div
        style={menuStyle}
        className="min-w-[180px] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95"
      >
        ...
        <button
          ...
          className="relative flex w-full cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
        >
          <Grid01 className="mr-2 h-4 w-4" aria-hidden="true" />
          Select All
        ...
        <button
          ...
          className="relative flex w-full cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
        >
          <Maximize02 className="mr-2 h-4 w-4" aria-hidden="true" />
          Fit View
        </button>
      </div>
    </>
