          ...
          <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
            ...
            >
              ...
              <motion.path
                ...
                strokeWidth="2"
                fill="none"
                style={{ pathLength: spring5 }}
              />

              {/* Blurred glow versions */}
              <defs>
                <filter id="glow">
