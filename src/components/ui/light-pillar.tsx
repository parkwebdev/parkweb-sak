 ...
 * 
 * WebGL-based animated light pillar effect using Three.js shaders.
 * Creates a mesmerizing rotating light beam effect with customizable colors.
 * @module components/ui/light-pillar
 */
  ...
  if (!webGLSupported) {
    return (
      <div className={`light-pillar-fallback ${className}`} style={{ mixBlendMode }}>
        {/* Silent fallback - no message needed */}
      </div>
    );
  }
