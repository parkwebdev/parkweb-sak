...
// Utility functions imported from lib/map-utils for code splitting
import { countryCodeToFlag, getMarkerSize, getMarkerFillColor } from '@/lib/map-utils';
// Re-export computeBounds for backward compatibility
export { computeBounds } from '@/lib/map-utils';
