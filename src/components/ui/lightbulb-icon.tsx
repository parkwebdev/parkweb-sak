...
interface LightbulbIconProps extends React.SVGAttributes<SVGSVGElement> {
  className?: string;
}

export const LightbulbIcon = React.forwardRef<SVGSVGElement, LightbulbIconProps>(
  ({ className, ...props }, ref) => {
    return (
      <svg
        ref={ref}
...
export const LightbulbIconFilled = React.forwardRef<SVGSVGElement, LightbulbIconProps>(
  ({ className, ...props }, ref) => {
    return (
      <svg
        ref={ref}
...
LightbulbIconFilled.displayName = "LightbulbIconFilled";