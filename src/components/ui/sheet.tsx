  ...
  "fixed z-50 bg-background p-6 rounded-xl border shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        right:
          "top-[calc(10px+1vh)] bottom-[calc(10px+1vh)] right-[19px] h-[calc(98vh-20px)] w-3/4 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
