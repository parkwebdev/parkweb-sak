...
// CSV File Icon - Green
export function CsvFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
...
// XLS File Icon - Green
export function XlsFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
    <svg width={width} height={height} fill="none" viewBox="0 0 40 40" className={className}>
      <path
        stroke="#D5D7DA"
...
export function XlsxFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
    <svg width={width} height={height} fill="none" viewBox="0 0 40 40" className={className}>
      <path
        stroke="#D5D7DA"
...
// PDF File Icon - Red
export function PdfFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
    <svg width={width} height={height} fill="none" viewBox="0 0 40 40" className={className}>
      <path
        stroke="#D5D7DA"
...
// DOC File Icon - Blue
export function DocFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
    <svg width={width} height={height} fill="none" viewBox="0 0 40 40" className={className}>
      <path
        stroke="#D5D7DA"
...
// DOCX File Icon - Blue
export function DocxFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
    <svg width={width} height={height} fill="none" viewBox="0 0 40 40" className={className}>
      <path
        stroke="#D5D7DA"
...
// TXT File Icon - Gray
export function TxtFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
    <svg width={width} height={height} fill="none" viewBox="0 0 40 40" className={className}>
      <path
        stroke="#D5D7DA"
...
export function PptFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
    <svg width={width} height={height} fill="none" viewBox="0 0 40 40" className={className}>
      <path
        stroke="#D5D7DA"
...
export function PptxFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
    <svg width={width} height={height} fill="none" viewBox="0 0 40 40" className={className}>
      <path
        stroke="#D5D7DA"
...
export function GenericFileIcon({ width = 40, height = 40, className }: FileIconProps) {
  return (
    <svg width={width} height={height} fill="none" viewBox="0 0 40 40" className={className}>
      <path
        stroke="#D5D7DA"
...
export function FileTypeIcon({ fileName, ...props }: FileIconProps & { fileName: string }) {
