 ...
 * JSON Export Icon
 * 
 * Custom SVG icon for the Import/Export dropdown.
 * 
 * @module components/admin/prompts/JsonExportIcon
 */

interface JsonExportIconProps {
  size?: number;
  className?: string;
}

export function JsonExportIcon({ size = 16, className }: JsonExportIconProps) {
  return (
    <svg 
      width={size} 
      height={size} 
    ...
    >
      ...
      />
      <rect width={34} height={16} x={1} y={18} className="fill-accent-purple" rx={2} />
      <path
        fill="#fff"
