/**
 * CsvExportIcon Component
 * 
 * Scalable CSV file icon for export buttons.
 * Based on the CsvIcon from analytics but with configurable size.
 * 
 * @module components/admin/shared/CsvExportIcon
 */
...
/**
 * Scalable CSV file icon for use in export buttons.
 */
export function CsvExportIcon({ size = 16, className }: CsvExportIconProps) {
  return (
    <svg 
      width={size} 
      height={size} 
    ...
    >
      <path
        className="stroke-[#D5D7DA] dark:stroke-muted-foreground/50"
        strokeWidth={1.5}
