    ...
    <aside className="w-64 shrink-0 border-r border-border bg-card overflow-y-auto flex flex-col">
      ...
      <nav className="p-2 space-y-4 flex-1">
        {groupOrder.map((group, groupIndex) => {
          ...
          return (
            <div key={group}>
              <h3 className="px-2 py-1 text-2xs font-medium text-foreground uppercase tracking-wider">
                {group}
              </h3>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          ...
                          <span className="flex items-center gap-1 text-2xs px-1.5 py-0.5 rounded font-medium bg-muted text-muted-foreground">
