    ...
    articles: [
      {
        ...
        component: lazy(() => import('@/data/help-center/getting-started/WelcomeArticle')),
      },
      {
        id: 'quick-start',
        slug: 'quick-start',
        ...
        component: lazy(() => import('@/data/help-center/getting-started/QuickStartArticle')),
      },
      {
        id: 'navigation',
        slug: 'navigation',
        ...
        component: lazy(() => import('@/data/help-center/getting-started/NavigationArticle')),
      },
      {
        id: 'dashboard',
        slug: 'dashboard',
        ...
        component: lazy(() => import('@/data/help-center/getting-started/DashboardOverviewArticle')),
      },
    ],
  },
  {
