    ...
    Tables: {
      ...
      calendar_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_events_conversation"
          ...
          {
            foreignKeyName: "fk_events_location"
            columns: ["location_id"]
            isOneToOne: false
      ...
      connected_accounts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_accounts_location"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
      ...
      conversation_memories: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_memories_conversation"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "conversations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_memories_lead"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "leads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_memories_message"
      ...
      conversations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_conversations_location"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
      ...
      help_articles: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_articles_agent"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
      ...
      knowledge_chunks: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_chunks_agent"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
      ...
      knowledge_sources: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_sources_agent"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_sources_location"
      ...
      locations: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_locations_agent"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
      ...
      notification_preferences: {
        Row: {
          ...
          team_email_notifications: boolean | null
      ...
      properties: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_properties_location"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_properties_source"
