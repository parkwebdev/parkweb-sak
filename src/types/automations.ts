    ...
    nodes: [
      {
        ...
        description: 'When a lead, booking, or conversation changes',
        icon: 'Zap',
        color: 'amber',
        defaultData: { label: 'When Event', event: 'lead.created' },
      },
      {
        ...
        icon: 'Clock',
        color: 'blue',
        defaultData: { label: 'Scheduled' },
      },
      {
        type: 'trigger-manual',
        label: 'You Click Run',
        description: 'Manually trigger from the dashboard',
        icon: 'Hand',
        color: 'green',
        defaultData: { label: 'Manual' },
      },
      {
        type: 'trigger-ai-tool',
        label: 'Ari Decides To',
        description: 'Let Ari trigger this during conversations',
        icon: 'Sparkles',
        color: 'purple',
    ...
    nodes: [
      {
        type: 'action-http',
        label: 'Call Webhook',
        description: 'Send data to Zapier, Make, or any URL',
        icon: 'Globe',
        color: 'blue',
        defaultData: { label: 'Call Webhook', method: 'POST', url: '' },
      },
      {
        type: 'action-email',
        label: 'Send Email',
      ...
      },
      {
        ...
        label: 'Update Lead',
        description: 'Change lead info, stage, or status',
        icon: 'User',
        color: 'green',
    ...
    nodes: [
      {
        type: 'ai-generate',
        label: 'Write with AI',
        description: 'Generate text, emails, or responses',
        icon: 'Sparkles',
        color: 'violet',
        defaultData: { label: 'AI Write', model: 'google/gemini-2.5-flash', outputVariable: 'ai_response' },
      },
      {
        type: 'ai-classify',
        label: 'Categorize',
        description: 'Sort into categories with AI',
        icon: 'Tag',
        color: 'violet',
        defaultData: { label: 'AI Categorize', categories: [], outputVariable: 'classification' },
      },
      {
        type: 'ai-extract',
        label: 'Extract Info',
        description: 'Pull out structured data with AI',
        icon: 'Search',
        color: 'violet',
