    ...
    <div className="px-6 py-3 border-t bg-background flex justify-around items-center">
      ...
      >
        <div className="relative">
          ...
          />
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 min-w-[16px] h-4 bg-destructive text-destructive-foreground text-2xs font-medium rounded-full flex items-center justify-center px-1">
