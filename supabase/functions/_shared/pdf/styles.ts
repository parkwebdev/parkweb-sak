/**
 * PDF Design System Styles for Edge Functions
 * 
 * Ported from src/lib/pdf-components/styles.ts
 * StyleSheet definitions for @react-pdf/renderer aligned with Pilot branding.
 */

// @ts-ignore - npm import for Deno
import { StyleSheet } from 'npm:@react-pdf/renderer@4.3.0';
...
export const styles = StyleSheet.create({
  // Page - all pages have top padding, header uses negative margin to offset on first page
  page: {
