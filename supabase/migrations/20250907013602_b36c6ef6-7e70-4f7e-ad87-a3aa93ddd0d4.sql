-- Update all email templates with proper logo URL and styling
  ...
  <div style="background-color: #ffffff; max-width: 600px; margin: 0 auto; border-radius: 8px; overflow: hidden;">
    ...
    <div style="background-color: #ffffff; padding: 40px 20px; text-align: center; border-bottom: 1px solid #e0e0e0;">
      <div style="background-color: #ffffff; border: 2px solid #f0f0f0; border-radius: 12px; width: 80px; height: 80px; margin: 0 auto; display: flex; align-items: center; justify-content: center;">
        <img src="https://mvaimvwdukpgvkifkfpa.supabase.co/storage/v1/object/public/email-assets/parkweb-logo.png" alt="ParkWeb Logo" style="width: 60px; height: 60px; border-radius: 8px;" />
      </div>
    </div>
