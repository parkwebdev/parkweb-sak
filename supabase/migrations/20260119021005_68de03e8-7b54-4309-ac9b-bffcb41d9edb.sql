...
SET content = E'<p>The System Prompt is the foundation of Ari\'s personality and behavior. It\'s a set of instructions that guides how Ari responds to visitors, handles conversations, and represents your brand.</p>
...
<div data-related-articles data-articles=\'[{"categoryId":"ari","articleSlug":"knowledge-sources","title":"Knowledge Sources"},{"categoryId":"ari","articleSlug":"appearance","title":"Customizing Appearance"}]\'></div>',
    description = E'Define Ari\'s personality and guidelines.',
    updated_at = NOW()
