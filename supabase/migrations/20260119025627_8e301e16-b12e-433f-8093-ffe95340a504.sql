-- =====================================================
-- POPULATE ALL 33 HELP CENTER ARTICLES WITH FULL CONTENT
-- =====================================================
-- This migration updates all platform_hc_articles with
-- complete HTML content matching the original TSX files.
-- =====================================================
...
<strong>Getting Started:</strong> Ready to set up your first AI agent? Head to the <a data-article-link data-category-id="getting-started" data-article-slug="quick-start">Quick Start Guide</a> to get Ari up and running in minutes.
</div>

<h2 id="next-steps">Next Steps</h2>
<p>Now that you understand what Pilot can do, here''s how to get started:</p>
<ol>
<li>Complete the <a data-article-link data-category-id="getting-started" data-article-slug="quick-start">Quick Start Guide</a> to configure Ari</li>
<li><a data-article-link data-category-id="ari" data-article-slug="knowledge-sources">Add knowledge sources</a> so Ari can answer questions about your business</li>
<li><a data-article-link data-category-id="ari" data-article-slug="appearance">Customize the chat widget</a> to match your brand</li>
<li><a data-article-link data-category-id="ari" data-article-slug="installation">Install the widget</a> on your website</li>
...
updated_at = now()
WHERE slug = 'welcome' AND category_id = 'getting-started';
...
updated_at = now()
WHERE slug = 'quick-start' AND category_id = 'getting-started';
...
updated_at = now()
WHERE slug = 'navigation' AND category_id = 'getting-started';
...
updated_at = now()
WHERE slug = 'dashboard' AND category_id = 'getting-started';


-- ARI CATEGORY
-- =====================================================

-- 5. Understanding Ari (Overview)
UPDATE platform_hc_articles 
...
<ul>
<li><a data-article-link data-category-id="ari" data-article-slug="system-prompt">System Prompt</a> – Define Ari''s personality and guidelines</li>
<li><a data-article-link data-category-id="ari" data-article-slug="knowledge-sources">Knowledge</a> – Add sources for Ari to learn from</li>
<li><a data-article-link data-category-id="ari" data-article-slug="appearance">Appearance</a> – Customize the look of the chat widget</li>
</ul>
...
updated_at = now()
WHERE slug = 'overview' AND category_id = 'ari';
...
updated_at = now()
WHERE slug = 'system-prompt' AND category_id = 'ari';

-- 7. Knowledge Sources
UPDATE platform_hc_articles 
SET content = '<p>Knowledge sources are how Ari learns about your business. The more relevant information you provide, the better Ari can assist your visitors.</p>
...
updated_at = now()
WHERE slug = 'knowledge-sources' AND category_id = 'ari';
...
updated_at = now()
WHERE slug = 'appearance' AND category_id = 'ari';
...
updated_at = now()
WHERE slug = 'welcome-messages' AND category_id = 'ari';
...
<li>A lead is created in your <a data-article-link data-category-id="leads" data-article-slug="overview">Leads</a> dashboard</li>
...
<p>Get notified when new leads are captured. Configure notifications in <a data-article-link data-category-id="settings" data-article-slug="notifications">Settings → Notifications</a>.</p>
...
updated_at = now()
WHERE slug = 'lead-capture' AND category_id = 'ari';
...
updated_at = now()
WHERE slug = 'locations' AND category_id = 'ari';
...
updated_at = now()
WHERE slug = 'help-articles' AND category_id = 'ari';
...
updated_at = now()
WHERE slug = 'announcements' AND category_id = 'ari';
...
updated_at = now()
WHERE slug = 'news' AND category_id = 'ari';
...
<li>Check your <a data-article-link data-category-id="inbox" data-article-slug="overview">Inbox</a></li>
</ol>
...
updated_at = now()
WHERE slug = 'installation' AND category_id = 'ari';
...
updated_at = now()
WHERE slug = 'overview' AND category_id = 'inbox';
...
<ol>
<li>Open the conversation in the <a data-article-link data-category-id="inbox" data-article-slug="overview">Inbox</a></li>
...
updated_at = now()
WHERE slug = 'takeover' AND category_id = 'inbox';
...
updated_at = now()
WHERE slug = 'overview' AND category_id = 'leads';
...
updated_at = now()
WHERE slug = 'stages' AND category_id = 'leads';
...
<p>Configure Ari''s booking behavior in <a data-article-link data-category-id="ari" data-article-slug="custom-tools">Custom Tools</a>.</p>
...
<p>See the <a data-article-link data-category-id="analytics" data-article-slug="report-builder">Report Builder guide</a> for detailed instructions.</p>
...
updated_at = now()
WHERE slug = 'overview' AND category_id = 'analytics';
...
updated_at = now()
WHERE slug = 'report-builder' AND category_id = 'analytics';
...
updated_at = now()
WHERE slug = 'general' AND category_id = 'settings';
...
updated_at = now()
WHERE slug = 'profile' AND category_id = 'settings';
...
<div data-related-articles data-articles=''[{"categoryId":"settings","articleSlug":"general","title":"General Settings"}]''></div>',
updated_at = now()
WHERE slug = 'team' AND category_id = 'settings';
...
updated_at = now()
WHERE slug = 'billing' AND category_id = 'settings';
...
updated_at = now()
WHERE slug = 'usage' AND category_id = 'settings';
...
updated_at = now()
WHERE slug = 'notifications' AND category_id = 'settings';
...
<div data-related-articles data-articles=''[{"categoryId":"settings","articleSlug":"profile","title":"Profile Settings"}]''></div>',
updated_at = now()
WHERE slug = 'sessions' AND category_id = 'settings';